...
| Integrante       | Tareas                                                                                                                                                                                                                                                                |
| ---------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Camilo Bejarano  | Validación y enmarcado del problema, diseño de la arquitectura de la API a desarrollar y validación cruzada del entregable de Sebastian. Commits:`414b556`.                                                                                                                                                                                                                     |
| German Rodriguez | Validación problema de negocio/técnico; creación repositorio Git; selección del dataset (unarXive) y pipeline de datos (harvest/enrich); reporte (Secciones 1–3); revisión cruzada del EDA. Commits:`94d5419`, `271d266`, `fecab37`, `5700cfa`. |
...
| Sebastian Toro   | Realicé los mockups, el tablero de análisis exploratorio (EDA) y la arquitectura; agregué estas secciones al entregable; además validé la entrega de Camilo (validación cruzada). Commits:`1c5c9b4`, `412c3d4`, `f7ece45`.                                                                                             |
