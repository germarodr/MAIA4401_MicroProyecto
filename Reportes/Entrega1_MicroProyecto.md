...
| Integrante       | Tareas                                                                                                                                                                                                                                                                |
| ---------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Camilo Bejarano  | Validación y enmarcado del problema, diseño de la arquitectura de la API a desarrollar y validación cruzada del entregable de Sebastian                                                                                                                                                                                                                     |
